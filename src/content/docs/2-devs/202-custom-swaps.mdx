...
This section assumes you are doing a native wallet integration – Your wallet will escrow funds for the Catalyst system while swaps are ongoing – otherwise see the [get started guide](/devs/get-started).
